            ...
            <div class="container px-4 px-lg-5 d-flex h-100 align-items-center justify-content-center">
                <div class="d-flex justify-content-center">
                    <div class="text-center">
                        <h1 class="mx-auto my-0 text-uppercase">Startup Base</h1>
                        <h2 class="text-white-50 mx-auto mt-2 mb-5">Empresa revolucionária no apoio e suporte a empresas.</h2>
        ...
        <section class="about-section text-center" id="about">
            <div class="container px-4 px-lg-5">
                <div class="row gx-4 gx-lg-5 justify-content-center">
                    <div class="col-lg-8">
                        <h2 class="text-white mb-4">Nosso Objetivo</h2>
                        <p class="text-white-50">
                        Nós somos uma incubadora com um programa colaborativo projetado para ajudar novas startups a ter sucesso. As nossas incubadoras ajudam os empresários a resolver alguns dos problemas comumente associados à execução de uma inicialização, fornecendo espaço de trabalho, apoio e treinamento.
                        </p>
                        <p class="text-white-50">
        ...
        <section class="contact-section bg-black">
            <div class="container px-4 px-lg-5">
                    ...
                    <div class="col-md-4 mb-3 mb-md-0">
                        <div class="card py-4 h-100">
                            <div class="card-body text-center">
                                ...
                                <hr class="my-4 mx-auto" />
                                <div class="small text-black-50"><a href="mailto:startupbase@gmail.com">startupbase@gmail.com</a></a></div>
                            </div>
                        </div>
                    </div>
                    <div class="col-md-4 mb-3 mb-md-0">
                ...
                <div class="social d-flex justify-content-center">
                    <a class="mx-2" href="https://x.com/"><i class="fab fa-twitter"></i></a>
